...
const Profile = () => {
  ...
  return (
    <div className="h-screen overflow-hidden bg-(--surface-primary) text-(--text-primary)">
      <div className="grid h-screen grid-cols-[212px_minmax(0,1fr)_340px] overflow-hidden">
        <DashboardSidebar />
        <DashboardCenterPane
          profile={profile}
